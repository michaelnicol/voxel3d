...
//  */
// export class Polygon<E extends Point, K extends Point> extends AVLObject<E> implements cloneable<Polygon<E, K>> {
//    vertices: E[] = []
...
//    }
//    changeVertices(v: E[]): Polygon<E, K> {
//       this.vertices = []
...
//       return this;
//    }
//    verticesHaveMutated(): Polygon<E,K> {
//       this.internalStorage.reset()
//       this.edgeStorage = {}
//       this.internalStorage.addCoordinates(this.vertices, false)
//       if (this.hasEdges) {
...
//             this.internalStorage.addCoordinates(coords, false)
//          } else {
...
//    fillPolygon(passes: number, useSort: boolean): Polygon<E, K> {
...
//    }
//    clone(): Polygon<E, K> {
//       let polygon = new Polygon<E, K>([...this.vertices].reduce((accumulator, value) => {
