...
//     */
//    root: AVLTree<TreeStorageNode> = new AVLTree<TreeStorageNode>(undefined, new TreeStorageComparator());
...
//    }
//    reset(): TreeStorage<E> {
//       this.root = new AVLTree<TreeStorageNode>(undefined, new TreeStorageComparator());
//       for (let i = 0; i < this.#maxDimensions; i++) {
//          this.#dimensionRange.set(i, [Number.MAX_SAFE_INTEGER, 0, Number.MIN_SAFE_INTEGER, 0]);
//          this.outdatedDimensionRanges.set(i, false)
//       }
...
//       return range;
//    }
//    hasCoordinate(coordinate: E): [boolean, number] {
...
//          return [false, 0];
//       }
//       let currentTree: TreeStorageNode = (this.root.getItem(nodeToFind) as AVLTreeNode<TreeStorageNode>).getValue() as TreeStorageNode;
...
//       if (!allowDuplicates && this.hasCoordinate(coordinate)[0]) {
//          return;
//       }
...
//       let nodeToReduceValue = (nodeToReduce.getValue() as TreeStorageNode).getData()
...
//    }
//    clone(): TreeStorage<E> {
//       const newStorage = new TreeStorage<E>(this.#maxDimensions)
